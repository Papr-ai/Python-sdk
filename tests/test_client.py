...
from papr import Papr, AsyncPapr, APIResponseValidationError
from papr._types import Omit
from papr._utils import maybe_transform
from papr._models import BaseModel, FinalRequestOptions
from papr._constants import RAW_RESPONSE_HEADER
from papr._exceptions import PaprError, APIStatusError, APITimeoutError, APIResponseValidationError
from papr._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
from papr.types.user_create_params import UserCreateParams
...
class TestPapr:
    ...
    @mock.patch("papr._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncPapr:
    ...
    def test_get_platform(self) -> None:
        ...
        from papr._utils import asyncify
        from papr._base_client import get_platform
