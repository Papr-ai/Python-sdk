...
pip install git+ssh://git@github.com/Papr-ai/docs.git
```
...
These methods return an [`APIResponse`](https://github.com/Papr-ai/docs/tree/main/src/papr/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/Papr-ai/docs/tree/main/src/papr/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/Papr-ai/docs/issues) with questions, bugs, or suggestions.
